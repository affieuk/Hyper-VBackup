...
function Convert-VmBackupCheckpoint
{
    ...
    $job = $Msvm_VirtualSystemSnapshotService.ConvertToReferencePoint($BackupCheckPoint) # Changed from $BackupSnapshot to $BackupCheckPoint
    ...
    $refPoint = (([WMI]$job.Job).GetRelated("Msvm_VirtualSystemReferencePoint") | ForEach-Object {$_})
...
function Export-VMBackupCheckpoint
{
    ...
    $Msvm_VirtualSystemExportSettingData = ($Msvm_ComputerSystem.GetRelated("Msvm_VirtualSystemExportSettingData","Msvm_SystemExportSettingData",$null,$null, $null, $null, $false, $null) | ForEach-Object {$_})
    ...
    # Specify the export options
        ...
        $Msvm_VirtualSystemExportSettingData.CopySnapshotConfiguration = 2 # Original was 3
        ...
        $Msvm_VirtualSystemExportSettingData.DifferentialBackupBase = $ReferenceSnapshot
...
function New-VmBackupCheckpoint
{
    ...
    $snapshot = (([WMI]$job.Job).GetRelated("Msvm_VirtualSystemSettingData") | ForEach-Object {$_})
